# nvim-treesitter-queries-faust

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-faust/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-faust/actions/workflows/validate.yml)

Neovim tree-sitter queries for **faust**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-faust",
...
- [ ] Changes are scoped to `faust` — do not include files for other languages
